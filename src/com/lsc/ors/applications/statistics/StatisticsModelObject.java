...
public abstract class StatisticsModelObject extends ModelObject{

	/**
	 * 
	 */
	private static final long serialVersionUID = 781627569980892191L;
	public int getID(){
	...
	public StatisticsModelObject(ModelListener listener) {
		super(listener);
