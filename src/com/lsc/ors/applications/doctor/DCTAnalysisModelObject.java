...
public abstract class DCTAnalysisModelObject extends ModelObject {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5989821571257428843L;
	...
	public DCTAnalysisModelObject(ModelListener listener) {
		super(listener);
